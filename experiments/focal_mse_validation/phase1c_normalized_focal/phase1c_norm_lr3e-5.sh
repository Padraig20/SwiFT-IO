#!/bin/bash
#SBATCH --job-name phase1c_norm_lr3e-5
#SBATCH -t 24:00:00
#SBATCH --nodes=1
...
EXPERIMENT_NAME="phase1c_norm_lr3e-5_${SLURM_JOB_ID}"
...
echo "  Gamma: 1.0"
echo "  Learning Rate: 3e-5 (balanced)"
echo "  Max Epochs: 5"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✅ Phase 1C (Normalized Focal, lr=3e-5) completed successfully!"
else
    echo "❌ Phase 1C (Normalized Focal, lr=3e-5) failed with exit code $EXIT_CODE"
fi
echo "End Time: $(date)"
echo "=========================================="
