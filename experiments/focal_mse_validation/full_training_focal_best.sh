#!/bin/bash
#SBATCH --job-name focal_best_30ep
#SBATCH -t 48:00:00
#SBATCH --nodes=1
...
echo "=========================================="
echo "Full Training: Best Focal MSE Configuration"
echo "Configuration: gamma=1.0, lr=5e-5, 30 epochs"
...
echo "  Experiment: Full Training with Best Config"
echo "  Loss Type: Focal MSE"
echo "  Focal Gamma: 1.0"
...
echo "  Purpose: Fair comparison to baseline (30 epochs)"
echo "=========================================="
echo ""
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✅ Full Training (Focal MSE gamma=1.0, lr=5e-5, 30 epochs) completed successfully!"
else
