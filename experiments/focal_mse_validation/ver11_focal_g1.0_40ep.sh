#!/bin/bash
#SBATCH --job-name ver11_focal_g1.0_40ep
#SBATCH -t 72:00:00
#SBATCH --nodes=1
...
echo "=========================================="
echo "Ver11 + Focal MSE Loss (Fair Comparison)"
...
EXPERIMENT_NAME="ver11_focal_g1.0_40ep_${SLURM_JOB_ID}"
...
echo "  Expected: Ver11 temporal + Focal hard sample focusing"
echo "=========================================="
echo ""
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "  3. Compare with Ver11 + Tweedie"
    echo "  4. Analyze which emotions benefit most from focal loss"
else
