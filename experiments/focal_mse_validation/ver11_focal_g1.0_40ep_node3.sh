#!/bin/bash
#SBATCH --job-name ver11_focal_g1.0_40ep_node3
#SBATCH -t 72:00:00
#SBATCH --nodes=1
...
echo "=========================================="
echo "Ver11 + Focal MSE Loss (NODE3 RERUN)"
echo "Configuration: gamma=1.0, lr=5e-5, 40 epochs"
...
LOSS_ARGS='--regression_loss_type focal_mse --focal_gamma 1.0'


echo ""
echo "=========================================="
echo "Training Configuration:"
echo "  🎯 RERUN ON STABLE NODE3"
echo "  Task Type: REGRESSION"
echo "  Loss Type: Focal MSE (gamma=1.0) ⭐"
echo "  Max Epochs: 40"
...
echo ""
echo "  📊 Previous result: Test MAE 0.484 (49% better than MSE!)"
echo "  🔧 Fixed: Using node3 instead of problematic node1"
echo "=========================================="
echo ""
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✅ Ver11 + Focal MSE training completed successfully!"
    echo ""
    echo "📝 Performance expectations:"
    echo "  - Test MAE: ~0.48 (vs MSE baseline 0.94)"
    echo "  - 49% improvement over MSE baseline"
    echo "  - Ready for paper!"
    echo ""
    echo "📊 Next Steps:"
    echo "  1. Check WandB: https://wandb.ai/snu-connectome/moviefmri"
    echo "  2. Compare emotion-wise improvements"
    echo "  3. Write regression results section"
else
