#!/bin/bash
#SBATCH --job-name norm_focal_30ep
#SBATCH -t 48:00:00
#SBATCH --nodes=1
...
echo "=========================================="
echo "Full Comparison: Normalized Focal MSE (BEST)"
echo "Configuration: lr=5e-5, 30 epochs"
...
LOSS_ARGS='--regression_loss_type normalized_focal_mse'
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✅ Full Training (Normalized Focal MSE, 30 epochs) completed successfully!"
else
