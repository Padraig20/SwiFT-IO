...
EXPERIMENT_NAME="phase1b_g1.0_lr1e-5_${SLURM_JOB_ID}"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✅ Phase 1B (gamma=1.0, lr=1e-5) completed successfully!"
else
    echo "❌ Phase 1B (gamma=1.0, lr=1e-5) failed with exit code $EXIT_CODE"
fi
echo "End Time: $(date)"
echo "=========================================="
