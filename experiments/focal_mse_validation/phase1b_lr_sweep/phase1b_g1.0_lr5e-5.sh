#!/bin/bash
#SBATCH --job-name phase1b_g1.0_lr5e-5
#SBATCH -t 24:00:00
#SBATCH --nodes=1
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✅ Phase 1B (gamma=1.0, lr=5e-5) completed successfully!"
else
    echo "❌ Phase 1B (gamma=1.0, lr=5e-5) failed with exit code $EXIT_CODE"
fi
echo "End Time: $(date)"
echo "=========================================="
