#!/bin/bash
#SBATCH --job-name phase1b_g1.0_lr3e-5
#SBATCH -t 24:00:00
#SBATCH --nodes=1
...
echo "=========================================="
echo "Phase 1B: Focal MSE LR Sweep"
echo "Configuration: gamma=1.0, lr=3e-5"
...
EXPERIMENT_NAME="phase1b_g1.0_lr3e-5_${SLURM_JOB_ID}"
...
echo "  Phase: 1B - LR Sweep"
echo "  Loss Type: Focal MSE"
echo "  Gamma: 1.0"
echo "  Learning Rate: 3e-5 (moderate)"
echo "  Max Epochs: 5"
echo "  Sequence Length: 20"
echo "  Model: swin4d_ver9"
echo "  Goal: LR optimization for gamma=1.0"
echo "=========================================="
echo ""
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✅ Phase 1B (gamma=1.0, lr=3e-5) completed successfully!"
else
    echo "❌ Phase 1B (gamma=1.0, lr=3e-5) failed with exit code $EXIT_CODE"
fi
echo "End Time: $(date)"
echo "=========================================="
