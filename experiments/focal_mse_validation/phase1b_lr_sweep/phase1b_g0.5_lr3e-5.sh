#!/bin/bash
#SBATCH --job-name phase1b_g0.5_lr3e-5
#SBATCH -t 24:00:00
#SBATCH --nodes=1
...
echo "Configuration: gamma=0.5, lr=3e-5"
...
LOSS_ARGS='--regression_loss_type focal_mse --focal_gamma 0.5'
...
echo "  Goal: LR optimization for gamma=0.5"
echo "=========================================="
echo ""
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✅ Phase 1B (gamma=0.5, lr=3e-5) completed successfully!"
else
    echo "❌ Phase 1B (gamma=0.5, lr=3e-5) failed with exit code $EXIT_CODE"
fi
echo "End Time: $(date)"
echo "=========================================="
