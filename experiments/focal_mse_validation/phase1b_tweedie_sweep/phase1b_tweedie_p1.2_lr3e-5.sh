#!/bin/bash
#SBATCH --job-name phase1b_tw_p1.2_lr3e-5
#SBATCH -t 24:00:00
#SBATCH --nodes=1
...
EXPERIMENT_NAME="phase1b_tweedie_p1.2_lr3e-5_${SLURM_JOB_ID}"
...
LOSS_ARGS='--regression_loss_type tweedie --tweedie_p 1.2'
...
echo "  Power parameter p: 1.2 (low zero-inflation)"
