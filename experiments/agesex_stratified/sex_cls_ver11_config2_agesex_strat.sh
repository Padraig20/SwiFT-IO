#!/bin/bash
#SBATCH --job-name sex_v11_agesex
#SBATCH -t 72:00:00
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# =============================================================================
# Sex Classification - Ver11 (Config 2) with Age+Sex Stratified Split
# Best AUROC config: patch [6,6,6,2], window [4,4,4,10], embed_dim=60
# Full training from scratch with Youden optimal threshold support
# =============================================================================

echo "=========================================="
echo "Sex Classification - Ver11 Config 2 (Age+Sex Stratified)"
...
EXPERIMENT_NAME="${SLURM_JOB_ID}_sex_cls_v11_agesex_strat_$(date +'%Y-%m-%d_%H-%M-%S')"

echo ""
echo "Configuration:"
echo "  Model: swin4d_ver11 (Config 2 - best AUROC)"
