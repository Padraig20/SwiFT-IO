...
# =============================================================================
# Sex Classification - Ver9 with Age+Sex Stratified Split
# Full training from scratch with Youden optimal threshold support
# =============================================================================

echo "=========================================="
echo "Sex Classification - Ver9 (Age+Sex Stratified)"
...
EXPERIMENT_NAME="${SLURM_JOB_ID}_sex_cls_v9_agesex_strat_$(date +'%Y-%m-%d_%H-%M-%S')"
