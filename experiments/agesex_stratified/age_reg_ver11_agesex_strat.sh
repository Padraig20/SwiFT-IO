#!/bin/bash
#SBATCH --job-name age_v11_agesex
#SBATCH -t 72:00:00
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# =============================================================================
# Age Regression - Ver11 (Config 2) with Age+Sex Stratified Split
# Best config: patch [6,6,6,2], window [4,4,4,10], embed_dim=60
# Full training from scratch
# =============================================================================

echo "=========================================="
echo "Age Regression - Ver11 Config 2 (Age+Sex Stratified)"
...
EXPERIMENT_NAME="${SLURM_JOB_ID}_age_reg_v11_agesex_strat_$(date +'%Y-%m-%d_%H-%M-%S')"
...
--patch_size 6 6 6 2 --num_classes 1 --num_targets 1 --decoder single_target_decoder
