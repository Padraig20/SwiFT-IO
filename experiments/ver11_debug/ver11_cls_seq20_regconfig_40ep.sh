#!/bin/bash
#SBATCH --job-name ver11_cls_s20_40ep
#SBATCH -t 72:00:00
#SBATCH --nodes=1
...
echo "=========================================="
echo "DEBUG: Ver11 Classification Seq20 (Regression Config)"
...
echo "  Window Size: [4, 4, 4, 20] (full temporal, same as regression) 🌟"
echo ""
...
echo ""
echo "  📊 Purpose:"
echo "  - Test if Ver11 encoder works properly"
echo "  - Compare with Ver11 regression (which fails to learn)"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✅ Ver11 Classification Seq20 completed!"
    echo ""
    echo "📝 Next Steps:"
    echo "  1. Check WandB: https://wandb.ai/snu-connectome/moviefmri"
    echo "  2. Compare loss curve with Ver11 regression"
    echo "  3. Check if classification learns (loss decreases)"
    echo "  4. Run Seq30 classification test next"
else
