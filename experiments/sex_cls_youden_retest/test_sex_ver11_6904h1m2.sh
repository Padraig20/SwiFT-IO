#!/bin/bash
#SBATCH --job-name test_sex_v11_6904h1m2
#SBATCH -t 24:00:00
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# =============================================================================
# TEST Sex Classification - Ver11 (6904h1m2) with Youden Optimal Threshold
# Config 2: patch [6,6,6,2], window [4,4,4,10], embed_dim=60
# =============================================================================

echo "=========================================="
echo "TEST Sex Classification - Ver11 (6904h1m2)"
...
CHECKPOINT="output/moviefmri/6904h1m2/checkpt-epoch=01-valid_acc=0.77.ckpt"

echo ""
echo "Configuration:"
echo "  Model: swin4d_ver11 (Config 2)"
echo "  Decoder: single_target_decoder"
echo "  Patch: [6,6,6,2], Window: [4,4,4,10]"
...
DEFAULT_ARGS="--project_name moviefmri --experiment_name retest_sex_v11_6904h1m2_youden_$(date +'%Y%m%d_%H%M%S')"
...
--sequence_length 20 --first_window_size 4 4 4 10 --window_size 4 4 4 10 --img_size 96 96 96 20 \
--patch_size 6 6 6 2 --num_classes 2 --num_targets 1 --decoder single_target_decoder \
