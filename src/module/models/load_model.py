...
from .encoder.swin4d_mamba import SwinTransformer4D as SwinTransformer4D_Mamba
...
def load_model(model_name, hparams=None):
    ...
    elif model_name == "swin4d_mamba":
        net = SwinTransformer4D_Mamba(
            img_size=hparams.img_size,
            in_chans=hparams.in_chans,
            embed_dim=hparams.embed_dim,
            window_size=hparams.window_size,
    ...
    elif model_name in ["single_target_scalar", "single_target_multitask"]:
        num_classes = 1 if model_name == "single_target_scalar" else hparams.num_targets
        net = SingleTargetDecoder(
            num_latents=embed_dim,
            num_latent_channels=dims,
