#!/bin/bash
#SBATCH --job-name phase1a_focal_g2.0
#SBATCH -t 24:00:00
#SBATCH --nodes=1
...
echo "Configuration: gamma=2.0 (recommended)"
...
LOSS_ARGS='--regression_loss_type focal_mse --focal_gamma 2.0'
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✅ Phase 1A (gamma=2.0) completed successfully!"
else
    echo "❌ Phase 1A (gamma=2.0) failed with exit code $EXIT_CODE"
fi
echo "End Time: $(date)"
echo "=========================================="
