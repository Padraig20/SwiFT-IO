#!/bin/bash
#SBATCH --job-name phase1a_focal_g2.5
#SBATCH -t 24:00:00
#SBATCH --nodes=1
...
echo "Configuration: gamma=2.5 (aggressive)"
...
LOSS_ARGS='--regression_loss_type focal_mse --focal_gamma 2.5'
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✅ Phase 1A (gamma=2.5) completed successfully!"
else
    echo "❌ Phase 1A (gamma=2.5) failed with exit code $EXIT_CODE"
fi
echo "End Time: $(date)"
echo "=========================================="
