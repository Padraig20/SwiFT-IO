#!/bin/bash
#SBATCH --job-name phase1a_focal_g0.5
#SBATCH -t 24:00:00
#SBATCH --nodes=1
...
echo "=========================================="
echo "Phase 1A: Focal MSE Gamma Sweep"
echo "Configuration: gamma=0.5 (very conservative)"
...
echo "  Phase: 1A - Gamma Sweep"
echo "  Loss Type: Focal MSE"
echo "  Gamma: 0.5 (very conservative)"
echo "  Max Epochs: 5"
echo "  Learning Rate: 5e-5"
echo "  Sequence Length: 20"
echo "  Model: swin4d_ver9"
echo "  Goal: Check convergence"
echo "=========================================="
echo ""
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✅ Phase 1A (gamma=0.5) completed successfully!"
else
    echo "❌ Phase 1A (gamma=0.5) failed with exit code $EXIT_CODE"
fi
echo "End Time: $(date)"
echo "=========================================="
