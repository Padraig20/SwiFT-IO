#!/bin/bash
#SBATCH --job-name phase1a_focal_g1.0
#SBATCH -t 24:00:00
#SBATCH --nodes=1
...
echo "Configuration: gamma=1.0 (conservative)"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✅ Phase 1A (gamma=1.0) completed successfully!"
else
    echo "❌ Phase 1A (gamma=1.0) failed with exit code $EXIT_CODE"
fi
echo "End Time: $(date)"
echo "=========================================="
