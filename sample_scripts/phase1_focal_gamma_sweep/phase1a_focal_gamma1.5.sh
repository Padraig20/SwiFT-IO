#!/bin/bash
#SBATCH --job-name phase1a_focal_g1.5
#SBATCH -t 24:00:00
#SBATCH --nodes=1
...
echo "Configuration: gamma=1.5 (moderate)"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✅ Phase 1A (gamma=1.5) completed successfully!"
else
    echo "❌ Phase 1A (gamma=1.5) failed with exit code $EXIT_CODE"
fi
echo "End Time: $(date)"
echo "=========================================="
